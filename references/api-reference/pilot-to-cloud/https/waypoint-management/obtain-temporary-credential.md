---
title: "获取上传临时凭证"
source: https://developer.dji.com/doc/cloud-api-tutorial/cn/api-reference/pilot-to-cloud/https/waypoint-management/obtain-temporary-credential.html
...
| » provider | string | false | none | 云厂商枚举值；* ali - 阿里云；* aws - 亚马逊云 |
